...
class Trainer(DefaultTrainer):
    """
    Extension of the Trainer class adapted to ZoRI.
    """
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type == "coco_instance_gzero":
            evaluator_list.append(InsSegzsiEvaluator(dataset_name, max_dets_per_image=300, output_dir=output_folder))
...
def setup(args):
    ...
    # Setup logger for "zori" module
    setup_logger(output=cfg.OUTPUT_DIR, distributed_rank=comm.get_rank(), name="zori")
    return cfg
