...
# Code reproduced from part of keras version provided by Dr. Xuming Zhang
# Spectral–Spatial Self-Attention Networks for Hyperspectral Image Classification, TGRS 2022
# the adopted dense net backbone is from https://github.com/bearpaw/pytorch-classification/blob/master/models/cifar/densenet.py
...
class SSSAN(nn.Module):
    def __init__(self, in_channels, class_count):
        super(SSSAN, self).__init__()
        self.in_channels = in_channels
        self.class_count = class_count

        self.spa_net = SpaNet(self.in_channels)
        self.spe_net = SpeNet()
