...
flattenDataDirTrain = "LeNet/overhead/train.csv"
flattenDataDirTest = "LeNet/overhead/test.csv"
...
def main():
    ...
    for epoch in range(40):
        ...
        torch.save(model.state_dict(), "./LeNet/cnn_model.pth")

    # model = torch.load(model.state_dict(),"cnn_model.pth")

    pd.DataFrame(saved_data).to_csv("./LeNet/loss_history.csv",index=False)
